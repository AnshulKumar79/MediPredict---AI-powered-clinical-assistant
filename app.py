...
#Loading ONNX session globally on startup to conserve memory(as free RAM limit:512MB on Render)
try:
...
async def analyze_lesion(
    ...
    try:
        #Reading the incoming image file
        ...
        #Prompt-engineering
        prompt = f"""
        You are an experienced and expert clinical dermatological companion. A localized deep learning ONNX model has categorized a patient's skin lesion.
        ...
        in about 150-200 words & in simple language ensuring that an ordinary person with NO medical background could understand easily
        """
